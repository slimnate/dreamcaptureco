...
<section class="background-radial-gradient mb-32 text-center text-gray-800 lg:text-left">
	<div
		...
		style="
            ...
            background-image: url('/images/placeholder_landscape.jpg');
            height: 500px;
          "
	>
		<div
		...
		>
			<div class="flex h-full items-center justify-center">
				<div class="max-w-[800px] px-6 py-6 text-center text-white md:py-0 md:px-12">
					...
					<button
						type="button"
						class="mt-6 inline-block rounded-full border-2 border-gray-200 px-6 py-2
	...
	>
		<div class="carousel-inner relative w-full overflow-hidden">
			...
			<div class="carousel-item active relative float-left w-full">
				...
				<div class="flex flex-wrap justify-center">
					<div class="w-full shrink-0 grow-0 basis-auto px-3 lg:w-8/12">
						<h5 class="mb-3 text-lg font-bold">Maria Kate</h5>
						<p class="mb-4 font-medium text-gray-700">Kansas City</p>
						<p class="mb-6 text-gray-500">
							...
							ligula sed lorem tincidunt dignissim. Nam sed cursus lectus. Proin non rutrum magna.
							Proin gravida, justo et imperdiet tristique, turpis nisi viverra est, nec posuere ex
							arcu sit amet erat. Sed a dictum sem. Duis pretium condimentum nulla.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="carousel-item relative float-left w-full">
				...
				<div class="flex flex-wrap justify-center">
					<div class="w-full shrink-0 grow-0 basis-auto px-3 lg:w-8/12">
						<h5 class="mb-3 text-lg font-bold">John Doe</h5>
						<p class="mb-4 font-medium text-gray-700">St. Louis</p>
						<p class="mb-6 text-gray-500">
							<svg
								aria-hidden="true"
								focusable="false"
			...
			<div class="carousel-item relative float-left w-full">
				...
				<div class="flex flex-wrap justify-center">
					<div class="w-full shrink-0 grow-0 basis-auto px-3 lg:w-8/12">
						<h5 class="mb-3 text-lg font-bold">Anna Deynah</h5>
						<p class="mb-4 font-medium text-gray-700">Wichita</p>
						<p class="mb-6 text-gray-500">
							<svg
								aria-hidden="true"
								focusable="false"
							...
							rutrum enim massa in ante. Curabitur in justo at lorem laoreet ultricies. Nunc ligula
