...
/* @image-tools-generate name(setahnie) image($lib/images/testimonials/setahnie-01.jpg) w(200;500) */
/* @image-tools-generate name(electra) image($lib/images/testimonials/electra-03.jpg) w(200;500) */
/* @image-tools-generate name(bri) image($lib/images/testimonials/bri-03.jpg) w(200;500) */
/* @image-tools-generate name(quinton) image($lib/images/testimonials/quinton-02.jpg) w(200;500) */
/* @image-tools-generate name(allyson) image($lib/images/testimonials/allyson-01.jpg) w(200;500) */
/* @image-tools-generate name(dani) image($lib/images/testimonials/dani-02.jpg) w(200;500) */
