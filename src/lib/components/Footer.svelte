<script>
	import IconFacebook from './icons/socials/IconFacebook.svelte';
	import IconGoogle from './icons/socials/IconGoogle.svelte';
	import IconInstagram from './icons/socials/IconInstagram.svelte';
</script>
...
<footer class="bg-gray-100 text-center text-gray-600 lg:text-left">
	...
	<div class="bg-gray-200 p-6 text-center">
		...
		<a class="font-semibold text-gray-600" href="https://tailwind-elements.com/"
			>Tailwind Elements</a
		>
	</div>
</footer>
